...
namespace Nav3D.Common
{
    ...
    public static class LineVoxelizer
    {
        ...
        public static List<Vector3Int> GetVoxels(Ray _Line, float _VoxelSize)
        {
            float tMax = 1f;
            List<Vector3Int> result = new List<Vector3Int>();

            Bounds startBucketBounds = UtilsMath.GetBucket(_Line.Start, _VoxelSize);
            ...
            Vector3Int rayStartBucket = UtilsMath.GetBucketIndex(rayStart, _VoxelSize);
            Vector3Int rayEndBucket = UtilsMath.GetBucketIndex(rayEnd, _VoxelSize);
