...
namespace Nav3D.Demo
{
    public class EnemySpawner : MonoBehaviour
    {
        ...
        [SerializeField] Nav3DAgentDescription m_EnemyDescr;
        ...
        void Spawn()
        {
            //create enemy description variant
            Nav3DAgentDescription descrVariant = m_EnemyDescr.GetDescriptionVariant();

            //instantiate cone body for it
            GameObject agentGO = DemoHelper.InstantiateAgentConeBody($"{name}_Enemy_{m_Counter++}", descrVariant.Radius, out _, _BodyColor: BlueTone());
