...
namespace Nav3D.Obstacles.Serialization
{
    class ObstacleInfoSingleSerializable : ObstacleInfoBaseSerializable
    {
        ...
        readonly string UNKNOWN_DESERIALIZATION_OBSTACLE_INFO_TYPE = $"Unknown obstacle info type: {0}";
        readonly string UNKNOWN_SERIALIZATION_OBSTACLE_INFO_TYPE = $"Unknown obstacle info single type: {0}";
