...
namespace Nav3D.Obstacles
{
    public partial class Obstacle : IBoundable
    {
        ...
        ObstacleInfoBase m_ObstacleInfo;
        Octree m_Octree;
        ...
        {
            return m_Octree.FindPath(_PointA, _PointB, _CancellationTokenExternal, _CancellationTokenTimeout);
        }

        public bool RayIntersectOccupiedLeaf(Common.Ray _Ray)
        {
            return Bounds.IntersectRay(_Ray) && m_Octree.RayIntersectOccupiedLeaf(_Ray);
        }
