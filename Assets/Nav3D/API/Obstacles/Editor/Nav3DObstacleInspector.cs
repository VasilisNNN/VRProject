...
namespace Nav3D.API.Editor
{
    ...
    public class Nav3DObstacleInspector : UnityEditor.Editor
    {
        ...
        const string OBSTACLE_DATA_SOURSE_SERIALIZATION = "Load from binary";
        const string OBSTACLE_DATA_SOURSE_RUNTIME = "Runtime";

        const string TIP_AUTO_ADD_CHILDS = "Auto add child transforms";

        const string TIP_AUTO_UPDATE_ENABLED = "Update automatically on transform change";
        ...
        readonly string SERIALIZING_STATUS_SERIALIZED_BY_LOADER = $"The obstacle is successfully baked and serialized in {nameof(Nav3DObstacleLoader)}.";
        readonly string SERIALIZING_STATUS_NOT_SERIALIZED_BY_LOADER = $"Obstacle is not serialized by {nameof(Nav3DObstacleLoader)}";

        readonly string PERFORM_OBSTACLES_BAKING_TIP = $"Bake obstacles in {nameof(Nav3DObstacleLoader)}. Otherwise, the obstacle will not be loaded in play mode.";
        ...
        SerializedProperty m_AutoAddChilds;
        ...
        SerializedProperty m_SerializedObstacle;
        ...
        void OnEnable()
        {
            m_AutoAddChilds = serializedObject.FindProperty("m_AutoAddChilds");
            ...
            m_SerializedObstacle = serializedObject.FindProperty("m_SerializedObstacle");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Application.isPlaying && m_Obstacle.enabled)
            {
                ...
                DrawOccupiedLeavesSettings();
                DrawFreeLeavesSettings();
                DrawGraphNodesSettings();
            }
        ...
        void ProcessingSettings()
        {
            ...
            m_ObstacleDataSource.enumValueIndex = GUILayout.SelectionGrid(
                ...
                new[] { OBSTACLE_DATA_SOURSE_RUNTIME, OBSTACLE_DATA_SOURSE_SERIALIZATION },
                2);
        ...
        void AutoAddChilds()
        {
            ...
            bool oldAutoAddChilds = m_AutoAddChilds.boolValue;
            m_AutoAddChilds.boolValue = EditorGUILayout.Toggle(TIP_AUTO_ADD_CHILDS, m_AutoAddChilds.boolValue);

            if (oldAutoAddChilds != m_AutoAddChilds.boolValue)
        ...
        void DrawOccupiedLeavesSettings()
        {
            ...
            m_OccupiedLeavesDrawingMode.intValue = GUILayout.SelectionGrid(m_OccupiedLeavesDrawingMode.intValue, new[] { DRAW_ALL_BUTTON, DRAW_SPECIFIC_ONE_BUTTON }, 2);
            ...
            if (m_OccupiedLeavesDrawingMode.intValue == 1)
            {
                ...
                m_OccupiedLeavesDrawingLayerNumber.intValue = EditorGUILayout.IntSlider(m_OccupiedLeavesDrawingLayerNumber.intValue, 0, octreeLevelCount - 1);
        ...
        void DrawFreeLeavesSettings()
        {
            ...
            m_FreeLeavesDrawingMode.intValue = GUILayout.SelectionGrid(m_FreeLeavesDrawingMode.intValue, new[] { DRAW_ALL_BUTTON, DRAW_SPECIFIC_ONE_BUTTON }, 2);
            ...
            if (m_FreeLeavesDrawingMode.intValue == 1)
            {
                ...
                m_FreeLeavesDrawingLayerNumber.intValue = EditorGUILayout.IntSlider(m_FreeLeavesDrawingLayerNumber.intValue, 0, octreeLevelCount - 1);
        ...
        void DrawGraphNodesSettings()
        {
            ...
            m_GraphNodesDrawingMode.intValue = GUILayout.SelectionGrid(m_GraphNodesDrawingMode.intValue, new[] { DRAW_ALL_BUTTON, DRAW_SPECIFIC_ONE_BUTTON }, 2);
            ...
            if (m_GraphNodesDrawingMode.intValue == 1)
            {
                ...
                m_GraphNodesDrawingLayerNumber.intValue = EditorGUILayout.IntSlider(m_GraphNodesDrawingLayerNumber.intValue, 0, octreeLevelCount - 1);
