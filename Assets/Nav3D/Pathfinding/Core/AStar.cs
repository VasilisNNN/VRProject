...
namespace Nav3D.Pathfinding
{
    public class AStar
    {
        ...
        public PathResolverResult GetPath()
        {
            ...
            m_Start = StartLeaf.Bounds.center;
            m_Goal = GoalLeaf.Bounds.center;
            ...
            while (m_OpenList.Count != 0)
            {
                ...
                if (CancellationTokenControl.IsCancellationRequested)
                    return new PathResolverResult(null, PathfindingResultCode.CANCELED);
        ...
        {
            Vector3 leafCenter = _Leaf.Bounds.center;
        ...
        {
            return _AccruedCost + ManhattanDistance(_LeafA.Bounds.center, _LeafB.Bounds.center);
        }
