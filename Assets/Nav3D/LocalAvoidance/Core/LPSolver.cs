...
namespace Nav3D.LocalAvoidance
{
    ...
    public class LPSolver
    {
        ...
        public abstract class Constraint
        {
            ...
            abstract public SpatialShape MainShape { get; }

            #endregion

            #region Public methods

            abstract public bool IsPointFitTo(Vector3 _Point);

            abstract public Vector3 FindBestBoundaryValue(Vector3 _Point);

            abstract public SpatialShape Intersection(Constraint _Other);

            public Intersection Intersection(ILine _Line) => LPSolver.Intersection.Create(MainShape, _Line);

            abstract public bool IsIntersect(Constraint _Other);

            abstract public bool IsIntersect(ILine _MathLine);
        ...
        static (ConstraintPlanar Constraint, float Distance)[] ConstructDistanceSortedTupleArray(
            ...
            _PlanarConstraints
                .Select(_Constraint => (Constraint: _Constraint,
                    Distance: _Constraint.Plane.Distance(_SphericalConstraint.Sphere.Center)))
