...
namespace UnityEditor.AI
{
    ...
    [CustomEditor(typeof(NavMeshSurfaceCustom))]
    class NavMeshSurfaceEditor : Editor
    {
        ...
        Bounds GetBounds()
        {
            var navSurface = (NavMeshSurfaceCustom)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            foreach (NavMeshSurfaceCustom navSurface in targets)
            {
        ...
        static void RenderBoxGizmoSelected(NavMeshSurfaceCustom navSurface, GizmoType gizmoType)
        {
            RenderBoxGizmo(navSurface, gizmoType, true);
        }

        [DrawGizmo(GizmoType.NotInSelectionHierarchy | GizmoType.Pickable)]
        static void RenderBoxGizmoNotSelected(NavMeshSurfaceCustom navSurface, GizmoType gizmoType)
        {
        ...
        static void RenderBoxGizmo(NavMeshSurfaceCustom navSurface, GizmoType gizmoType, bool selected)
        {
        ...
        public static void CreateNavMeshSurface(MenuCommand menuCommand)
        {
            ...
            go.AddComponent<NavMeshSurfaceCustom>();
