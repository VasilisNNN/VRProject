...
namespace UnityEngine.AI
{
    ...
    [AddComponentMenu("Navigation/NavMeshSurfaceCustom", 30)]
  
    public class NavMeshSurfaceCustom : MonoBehaviour
    {
        [SerializeField]
        int m_AgentTypeID;
        ...
        static readonly List<NavMeshSurfaceCustom> s_NavMeshSurfaces = new List<NavMeshSurfaceCustom>();

        public static List<NavMeshSurfaceCustom> activeSurfaces
        {
        ...
        static void Register(NavMeshSurfaceCustom surface)
        {
#if UNITY_EDITOR
        ...
        static void Unregister(NavMeshSurfaceCustom surface)
        {
        ...
        bool UnshareNavMeshAsset()
        {
            ...
            var prefab = UnityEditor.PrefabUtility.GetCorrespondingObjectFromSource(this) as NavMeshSurfaceCustom;
